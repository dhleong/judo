...
class MapManagerTest {
    ...
    @Test fun `Render to primary window by default`() {
        ...
        mapper.render()
        assertThat(buffer).hasSize(judo.renderer.windowHeight)
    }
    ...
    @Test fun `Don't clear the primary window`() {
        ...
        mapper.render()
        assertThat(buffer).doesNotHaveLine("Test".toFlavorable())
    }
